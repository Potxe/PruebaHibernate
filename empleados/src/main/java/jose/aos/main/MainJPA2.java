	...
	public static void main(String[] args) {
		...
		try{
			...
			try //realizamos la "transaccion"
			{
				...
				rg = em.find(Regions.class, new BigDecimal(1));
		...
		//al cerrar el entitymanager ya esta desconetado, porloq ue al ser lazy se intenta conectar y casca.
		// haciendo que no sea lazy sino sea EAGER rula
